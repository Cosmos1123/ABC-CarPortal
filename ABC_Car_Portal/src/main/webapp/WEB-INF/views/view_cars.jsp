...
<body>
	...
	<div class="container-fluid bg-success">
		<div>
			<h2 class="text-center" style="color:black;">List of the Cars</h2>
			...
			<div class="row">
				...
				<sec:authorize access="hasRole('Users')">
					<a href="new_car">
						<button class="btn btn-success" style="color:black;">Post A Car For Sale</button>
					</a>	
				</sec:authorize>

				<c:url var="get_search_url" value="search"/>
				<form action="${get_search_url}" id="myform" method="get" class="form-inline text-right" style="padding:30px;padding-top:10px;">
