...
<body>
	...
	<!-- First Container -->
	<div class="container-fluid bg-success text-center" style="height:600px;padding-top:-30px;">
		<h3 class="margin" style="color:black;">Fill Your Car's Information!</h3>
		...
		<div class="row">
            ...
            This tag adds jsessionid to the action/href url, in case cookies are disabled by the user.
				...
				<form action="${post_url}" id="myform" method="post">
					...
					<div class="form-group">
					<label for="registeration" style="color:black;"> Registration:</label> 
					...
					<input type="submit" style="color:black;" name="Add" value="Post Car's Info" />
					<input type="button" style="color:black;" value="Cancel" onclick="cancel()"/>
