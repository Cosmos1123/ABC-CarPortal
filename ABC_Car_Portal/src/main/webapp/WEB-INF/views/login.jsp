...
<body>
	...
	<!-- First Container -->
	<div class="container-fluid bg-success text-center" style="height:500px;">
		<h3 class="margin" style="color:black;">Already registered! Please Login..</h3>
		...
		<h3 class="margin" style="color:black;">If you are new user! Please <a href="new" > Register </a> Here!</h3>
