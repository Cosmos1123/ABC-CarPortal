...
<body>
	...
	<div class="container-fluid bg-1">
		...
		<div class="row">
		<h3 class="margin text-center" style="color:black;">Detail Car Information !</h3>
						...
						<div class="col-sm-8" style="padding: 20px;">
							...
							<form action="car_detail?id=${car.id}" method="post">
								<input type="hidden" name="id" value="${car.id}" /> <input
									...
									placeholder="Enter the Price" name="bitprice" />

								<div class="form-group" style="padding: 20px;">
									<input type="submit" value="Bit Car" class="btn btn-success">
									<a href="cars" class="btn btn-info   ">Go Back</a>
								</div>
			...
			<div class="col-md-3 bg-3">
				<h4>Bidding Price!</h4><br/>
			<c:forEach var="car_bidding" items="${bidinfo}">
				
				<div class="card mb-3 card bg-success" style="padding:10px;">
				
					<div class="row" >
						<div class="col-md-4">
							<img class="card-img-top"
							src="/ABC_Car_Portal/images/avator.png" width="30px" class="rounded-circle"
							class="mr-3" alt=".. ">
						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<p class="card-text">Bidding Price: ${car_bidding.bidderPrice}</p>
